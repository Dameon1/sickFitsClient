...
describe('<CreateItem/>', () => {
  ...
  it('handles state updating', async () => {
    ...
    wrapper.find('#price').simulate('change', { target: { value: 500000, name: 'price', type: 'number' } });
    wrapper.find('#description').simulate('change', { target: { value: 'Really nice item', name: 'description' } });
    expect(wrapper.find('CreateItem').instance().state).toMatchObject({
      title: 'Testing',
      price: 500000,
      description: 'Really nice item',
    });
  });
